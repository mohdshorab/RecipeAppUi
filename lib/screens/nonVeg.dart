...
import 'package:recipe_app_ui/services/NonVegFoodService.dart';

import '../utils/constant.dart';

class NonVegPage extends StatelessWidget {
  static const String routeName = '/nonVegPage';

  final speakers = NonVegTypeService().getSpeaker();

  NonVegPage({Key? key}) : super(key: key);
